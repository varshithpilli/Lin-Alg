...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculateInverse() {
        ...
        fetch(`${base_url}/calculate/inverse`, {
            method: 'POST',
            headers: {
    ...
    function calculateOrthonormal() {
        ...
        fetch(`${base_url}/calculate/orthonormal`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    function calculateBases() {
        ...
        fetch(`${base_url}/calculate/bases`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    function calculateEqns() {
        ...
        fetch(`${base_url}/calculate/equations`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
